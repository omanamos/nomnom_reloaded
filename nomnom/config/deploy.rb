set :application, "nomnom"

set :repository, "https://github.com/omanamos/nomnom_reloaded"

# NOTE: for some reason Capistrano requires you to have both the public and
# the private key in the same folder, the public key should have the 
# extension ".pub".
ssh_options[:keys] = ["#{ENV['HOME']}/.ssh/nomnom.pem"]

# Your EC2 instances. Use the ec2-xxx....amazonaws.com hostname, not
# any other name (in case you have your own DNS alias) or it won't
# be able to resolve to the internal IP address.
role :web,      "ec2-50-16-2-37.compute-1.amazonaws.com"
role :memcache, "ec2-50-16-2-37.compute-1.amazonaws.com"
role :db,       "ec2-50-16-2-37.compute-1.amazonaws.com", :primary => true
...
set :ec2onrails_config, {
  ...
  :restore_from_bucket => "omanamos_storage",
  ...
  # desired.
  # NOTE: this only applies if you are not using EBS
  :archive_to_bucket => "omanamos_storage",
  ...
  # remove this.
  :mail_forward_address => "omanamos.webmaster@gmail.com",
